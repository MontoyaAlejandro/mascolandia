                    ...
                    <form method="POST" action="ControlProductos">
                        ...
                        <div class="row ">
                            ...
                            <div class="form-floating mimargen ">
                                    ...
                                    <label for="floatingInput ">Stock de Produto:</label>
                                </div>
                            </div>
                            <!--formulario izquierda-->
                            <div class="col-3 ">
                    ...
                    <table class="table table-hover ">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>                      
                                    <a href="actualizar.jsp?id_Producto=<%=listaProducto.get(i).getId_Producto()%>"><button type="button" class="btn btn-outline-success btn-sm ">Actualizar</button></a>                                    
                                    <a href="ControlProductos?id_Producto=<%=listaProducto.get(i).getId_Producto()%>"><button type="button" class="btn btn-outline-danger btn-sm ">Eliminar</button></a>
